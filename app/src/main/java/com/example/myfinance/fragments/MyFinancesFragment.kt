...
class MyFinancesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //swipeRefreshLayout view initialized
        ...
        //Load all finance data function + Refresh spinner will spin until data is loaded
        swipeRefreshLayout.isRefreshing = true
        loadFinanceData()

        //Refreshing RecyclerList will run loadFinanceData() function
